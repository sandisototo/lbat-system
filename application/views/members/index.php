                  ...
                  <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%" datatable="ng">
                    ...
                    <tbody>
                      <tr dt-rows ng-repeat="(i, member) in all_members" ng-class="{selected: $index===selected_index}">
                        ...
                        <td>{{member.timestamp | date:'medium'}}</td>
                        <td>........</td>
                        <td>........</td>
                        <td>Active</td>
                        <td>
        ...
        <div class="input-group">
          ...
          <div class="input-group">
            ...
            <div class="input-group">
                ...
                <input id="Date Of Birth" name="Date Of Birth" type="text" placeholder="Date Of Birth" class="form-control input-md" disabled>
               </div>
            </div>
            ...
            <div class="modal-footer ">
              ...
              <!--Depandants table -->
              <center>
                <h4 style="margin-top: 10%;">Depandants</h4>
                <!--p>You have no depandants</p-->
              </center>
              ...
              <tbody> <!-- para abrir em outra aba adicionar target="_blank" -->
               ...
               <button type="button" class="btn btn-info btn-sm pull-right" data-dismiss="modal"><span class="glyphicon glyphicon-plus-sign"></span> Add </button>
            </div>
          </div>
      <!-- /.modal-content -->
    </div>
