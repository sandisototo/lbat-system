...
.controller("MessagesController", ['$http', '$scope', '$window', 'SharedProperties', 'toastr', 'MainFactory', '$filter', function($http, $scope,$window, SharedProperties, toastr, mainFactory, $filter){
